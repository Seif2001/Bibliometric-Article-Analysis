...
1. Download the code as a zip and then unzip it or use git clone command to download the code
2. Go to the directory to where the code was saved
3. Right click and click on "Run in Terminal" option.
![image](https://user-images.githubusercontent.com/78408934/187026405-b51781b7-e9ea-4fd3-b5cf-6f99db5ab736.png)
4. Copy and paste the contents of "Run.txt" into the terminal
5. Control + click on the outputed link which will take you to the website
